...
// [1]암호 손동작 설정. open setMotion.py
// 파라미터로 docName, action 전달
...
// 저장된 seq 데이터의 shape를 출력하는데 잘 되었으면 (270, 90, 100) 이런식으로 뜸 (270개의 시퀀스, 각 시퀀스는 90프레임으로 구성, 각 프레임은 100개의 특성 값)
// seq 데이터 부족한 경우 다시 수행해야함. 손을 아에 인식 못하면 (0,) 이런식으로 뜸.
// 시퀀스 개수 200이하일 경우 충분하지 않다고 판단 -> false 전달 하도록 했음. 충분할 경우 true
